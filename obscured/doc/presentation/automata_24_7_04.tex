...
\begin{definition}[Letter-to-letter projection] \label{def:ltol}
...
\begin{definition}[Reverse reading] \label{def:revread}
...
\begin{lemma}[The pumping lemma for regular languages] \label{lem:pump}
...
\begin{theorem} \label{thm:fibonsys}
...
\begin{theorem} \label{thm:fibonaccifix}
